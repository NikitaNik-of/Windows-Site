...
const Link = ({LinkIcon = Globe, onDoubleClick, isfocused=false, LinkName = "", id, ...props}) => {
    ...
    return (
        <motion.div {...props} drag dragElastic={0} dragMomentum={false} onDoubleClick={onDoubleClick} className={clN + " fixed cursor-pointer aspect-square h-16 left-1.25 flex flex-col items-center text-center text-[12px] " + initPos(id)}>
